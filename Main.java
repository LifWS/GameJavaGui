...
public class Main extends JFrame {
    ...
    public Main() {
        ...
        JLabel j = new JLabel("Welcome to My Games SS");
        JLabel i = new JLabel(icon);
        // label and text entry field
        JLabel jl = new JLabel("Name Moster (Please Enter) :");
        jtf  = new JTextField(30);   // 25 chars wide
        c.add( j );
        c.add( i );
        c.add( jl );
        c.add( jtf );
		...
		// Radio Button
		final JRadioButton radio1 = new JRadioButton("Acholyte");
		radio1.setBounds(119, 58, 109, 23);
		getContentPane().add(radio1);
		
		final JRadioButton radio2 = new JRadioButton("Magician");
		radio2.setBounds(119, 84, 109, 23);
		getContentPane().add(radio2);
		
		final JRadioButton radio3 = new JRadioButton("Swordsman");
        ...
        Atkmon = 50;
        HPmon = 50;
        JLabel namem = new JLabel("                  Name : Acnologia");
        JLabel atkm = new JLabel("Attack : "+Atkmon);
        JLabel hpm = new JLabel("HP : "+HPmon+"            ");
        c.add( namem );
        c.add( atkm );
        c.add( hpm );
		...
		bat.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                ...
                if(HPmont <= 0&&HP>0){
                    ...
                    amount++;
                    item +=1;
                    final ImageIcon ibat = new ImageIcon(getClass().getResource("battlegif.gif"));
